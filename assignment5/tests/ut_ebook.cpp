...
{
protected:
    EBook *a = new EBook{6001, "Signals Systems and Transforms fifth edition", "Charles L. Phillips, John M. Parr, Eve A. Riskin"};
    EBook *b = new EBook{6002, "Power Systems Analysis second edition", "Arthur R.Bergen, Vijay Vittal"};
